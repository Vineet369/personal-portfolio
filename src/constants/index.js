...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      `● Reactbasedpasswordgenerator for generating unique strong passwords.
      ● Specialcharacters, numbers, and length can be dynamically updated in real time.
      ● Copybuttontocopypassword directly to clipboard.`,
